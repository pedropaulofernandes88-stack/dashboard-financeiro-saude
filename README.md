...
Versão demonstrativa privada, sem publicação em hospedagem externa. O build está pronto para servir como aplicação estática quando o destino de hospedagem for definido. A escolha de licença para distribuição futura permanece com o proprietário do repositório (`UNLICENSED`).
